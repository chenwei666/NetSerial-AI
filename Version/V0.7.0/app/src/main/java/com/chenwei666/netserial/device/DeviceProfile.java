...
public final class DeviceProfile {
    ...
    public DeviceProfile withVendor(Vendor detectedVendor) {
        return new DeviceProfile(name, Objects.requireNonNull(detectedVendor, "detectedVendor"),
                cliMode, baudRate, environment, protectedDevice, managementAddress);
    }
