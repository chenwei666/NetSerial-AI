# NetSerial AI 运维终端 V0.3.0

[中文](README.md) | [English](README_EN.md)

V0.3.0 在保留 USB 串口、AI 多厂商接入、设备记忆和离线补全的基础上，新增独立 SSH/Telnet 远程终端、分类命令库和完整应用设置。
...
脚本把项目镜像到 `C:\tmp\NetSerial-build`，然后执行 `testDebugUnitTest`、`lintDebug` 和 `assembleDebug`。需要 JDK 17 与 Android SDK 36。
