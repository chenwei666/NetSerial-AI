...
public class TerminalFragment extends Fragment implements ServiceConnection, SerialListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.clear) {
            ...
            return true;
        } else if (id == R.id.operations_center) {
            startActivityForResult(new Intent(requireContext(), OperationsCenterActivity.class)
                            .putExtra(OperationsCenterActivity.EXTRA_PICK_MODE, true)
                            .putExtra(OperationsCenterActivity.EXTRA_CAPTURE, terminalBuffer.tail(100_000)),
                    OPERATIONS_REQUEST);
            return true;
