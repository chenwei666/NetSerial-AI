...
| SSH | Interactive shell, manual first-use host-key verification, known-host persistence, and changed-key blocking; passwords are never persisted. |
...
- [AI provider compatibility](Version/V0.3.1/docs/AI_PROVIDER_COMPATIBILITY.md)
- [Architecture](Version/V0.3.1/docs/ARCHITECTURE.md)
- [Production release and signing](Version/V0.3.1/docs/RELEASE.md)
...
- 23 test suites and all 69 unit tests passed.
...
- SSH currently supports password authentication; private keys, jump hosts, proxies, and port forwarding are not implemented.
